...
public class Utilities {
	...
	/**
	 * 
	 * @Title: isStringInteger   
	   * @Description: Busca en una cadena de texto si es un numero entero 
	 * @param: @param palabra
	 * @param: @return true si la cadena son numeros enteros, si no devuelve false      
	 * @return: boolean      
	 * @throws
	 * @author Angela Acosta
	 */
	
	public static boolean isStringInteger(String palabra) {
		boolean esEnt = false;//palabra.matches("-?\\d+");
	...
	/**
	 * 
	 * @Title: isValidIdentification   
	   * @Description: TODO devuelve true si  contiene caracteres especiales, se omite el caracter %
	 * @param: @param word
	 * @param: @return      
	 * @return: boolean
	 * @author Angela Acosta      
